...
for i in range(7,18):
    ...
    ################################ READ NC FILES ############################
    f_dir= '/home/subeen/ENVI/output/SUMMER/'

    f_PMV1 = '/PMV/exp1_summer_BIO_PMV_2018-12-21_' # exp1_summer_AT_2018-12-21_07.00.01
    f_PMV2 = '.00.01.nc'

    f_AT1 = '/ATMO/exp1_summer_AT_2018-12-21_' # exp1_summer_AT_2018-12-21_07.00.01
    f_AT2 = '.00.01.nc'
    ...
    f_dir_out= '/home/subeen/ENVI/output/SUMMER/NaN/'
    f_out1 = 'NaN_exp1_summer_2018-12-21_' # exp1_summer_AT_2018-12-21_07.00.01
    f_out2 = '.00.01.nc'
...
"""R
    ...
    ######################################## MIN, MAX, AVG ##################################
    for var in key3d:
        mins.get(var, []).append(np.nanmin(data3d_nan[var]))
        maxes.get(var, []).append(np.nanmax(data3d_nan[var]))
        means.get(Var, []).append(np.nanmean(data3d_nan[var]))
"""
